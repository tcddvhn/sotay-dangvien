...
2. Tạo tài khoản admin đầu tiên và test login thực tế
3. Cấu hình `ApiKey` chatbot và test gateway AI thực tế
4. Bắt đầu chỉnh frontend bản sao để đổi endpoint
5. Sau đó mới mở CRUD quản trị chi tiết cho từng màn hình
